...
| T2 | Token-cost / abuse claims | 14-day auto-release, 24h SLA | Rate-limit per GitHub-user (≤2 active claims) |
...
| **T8** | **Sock-puppet identity** (нові GitHub usernames для evade rate-limits) | — | **No obvious mitigation — design-flag для future. Можливо: GitHub account age threshold або email-domain check, обидва hostile до legit volunteers** |
...
**Загалом 11-13 днів elapsed для production-ready GA**, з яких ~6 днів фокусованого coding.
