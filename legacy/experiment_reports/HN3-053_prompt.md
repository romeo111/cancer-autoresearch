...
## Patient Case
- **Cancer type**: Mucosal melanoma of the nasal septum — recurrent after prior resection
- **Stage**: Recurrent (rT2N0M0, 18 months after initial lateral rhinotomy)
- **Molecular markers**: BRAF wild-type, NRAS Q61R mutated, KIT wild-type, PD-L1 TPS 40%
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: prior nasal septum mucosal melanoma resection
- **Comorbidities**: nasal obstruction, saddle nose deformity from prior surgery
...
Save the JSON report to: experiment_reports/HN3-053_report.json
