...
- **Stage**: Stage IVA (T4aN0M0, orbital invasion)
- **Molecular markers**: mixed epithelial/mesenchymal/neuroectodermal components, no specific actionable mutations
...
Save the JSON report to: experiment_reports/HN3-048_report.json
