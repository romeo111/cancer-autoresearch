...
- **Molecular markers**: EBV+ (EBER+), PD-L1 CPS >=50, undifferentiated morphology
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: Southeast Asian/Inuit descent
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-023_report.json
