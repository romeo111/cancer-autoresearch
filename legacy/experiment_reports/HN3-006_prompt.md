...
## Patient Case
- **Cancer type**: Posterior pharyngeal wall squamous cell carcinoma
- **Stage**: Stage III (T3N1M0)
- **Molecular markers**: PD-L1 CPS 15, TP53 mutated
...
Save the JSON report to: experiment_reports/HN3-006_report.json
