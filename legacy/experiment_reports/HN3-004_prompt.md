...
## Patient Case
- **Cancer type**: Tonsillar squamous cell carcinoma — HPV-negative
- **Stage**: Stage IVA (T3N2bM0)
- **Molecular markers**: HPV p16-, PD-L1 CPS 5, TP53 mutated, CCND1 amplified
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: 35 pack-year smoking, heavy alcohol
- **Comorbidities**: alcohol-related cardiomyopathy
...
Save the JSON report to: experiment_reports/HN3-004_report.json
