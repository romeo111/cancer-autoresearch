...
## Patient Case
- **Cancer type**: Extranodal NK/T-cell lymphoma, nasal type (EBV-positive)
- **Stage**: Stage IE (localized nasal cavity)
- **Molecular markers**: EBV+ (EBER+), CD56+, cytoplasmic CD3+, PD-L1 high
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: East Asian descent
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-015_report.json
