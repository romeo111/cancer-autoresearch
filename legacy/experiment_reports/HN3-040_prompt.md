...
## Patient Case
- **Cancer type**: Sinonasal adenocarcinoma — non-intestinal type (high-grade)
- **Stage**: Stage III (T3N0M0, ethmoid)
- **Molecular markers**: TP53 mutated, no specific actionable targets
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: no occupational exposure
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-040_report.json
