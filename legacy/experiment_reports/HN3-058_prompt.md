...
## Patient Case
- **Cancer type**: Mucosal-associated lymphoid tissue (MALT) lymphoma of the parotid (Sjogren's-associated)
- **Stage**: Stage IE (localized to parotid)
- **Molecular markers**: CD20+, BCL2+, t(11;18) positive, IgG4 negative
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: Sjogren's syndrome 12 years
- **Comorbidities**: Sjogren's (xerostomia, xerophthalmia), bilateral parotid enlargement
...
Save the JSON report to: experiment_reports/HN3-058_report.json
