...
## Patient Case
- **Cancer type**: Ewing sarcoma of the mandible (rare adult presentation)
- **Stage**: Localized (mandibular body, 5cm)
- **Molecular markers**: EWSR1-FLI1 fusion positive, CD99+, NKX2-2+
...
Save the JSON report to: experiment_reports/HN3-054_report.json
