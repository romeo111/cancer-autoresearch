...
## Patient Case
- **Cancer type**: Glottic squamous cell carcinoma — very early T1a (single vocal cord)
- **Stage**: Stage I (T1aN0M0)
- **Molecular markers**: PD-L1 CPS <1
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 15 pack-year smoking, voice professional (teacher)
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-011_report.json
