...
## Patient Case
- **Cancer type**: Papillary thyroid carcinoma — tall cell variant (aggressive)
- **Stage**: Stage II (T3bN1bM0, AJCC 8th for age <55)
- **Molecular markers**: BRAF V600E+, TERT promoter mutated, tall cell variant >30%
...
Save the JSON report to: experiment_reports/HN3-025_report.json
