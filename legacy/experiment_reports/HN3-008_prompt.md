...
## Patient Case
- **Cancer type**: Nasopharyngeal carcinoma — recurrent/metastatic after definitive CRT
- **Stage**: Recurrent (rT2rN0M1, liver metastases, 2 years post-CRT)
- **Molecular markers**: EBV+, PD-L1 CPS >=20, rising plasma EBV DNA
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: initial stage III NPC treated with GP induction + CRT
- **Comorbidities**: cisplatin-induced neuropathy, hearing loss
...
Save the JSON report to: experiment_reports/HN3-008_report.json
