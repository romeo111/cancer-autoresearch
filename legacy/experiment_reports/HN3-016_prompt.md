...
## Patient Case
- **Cancer type**: Diffuse large B-cell lymphoma of Waldeyer's ring (tonsil)
- **Stage**: Stage IIE (tonsil + bilateral cervical nodes)
- **Molecular markers**: CD20+, BCL6+, MYC negative, GCB subtype
...
Save the JSON report to: experiment_reports/HN3-016_report.json
