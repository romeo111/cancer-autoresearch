...
## Patient Case
- **Cancer type**: Upper alveolar ridge (maxillary gingival) squamous cell carcinoma
- **Stage**: Stage IVA (T4aN1M0, palatal bone invasion)
- **Molecular markers**: PD-L1 CPS 10, TP53 mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: smokeless tobacco 20 years
...
Save the JSON report to: experiment_reports/HN3-001_report.json
