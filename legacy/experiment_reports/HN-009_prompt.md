...
## Patient Case
- **Cancer type**: Recurrent/metastatic head and neck squamous cell carcinoma (R/M HNSCC)
- **Stage**: Stage IVC (recurrence with lung metastases)
- **Molecular markers**: PD-L1 CPS ≥20, TMB-high (≥10 mut/Mb), PIK3CA mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: prior chemoRT for stage III oropharyngeal SCC 2 years ago
...
Save the JSON report to: experiment_reports/HN-009_report.json
