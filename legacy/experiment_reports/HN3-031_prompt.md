...
## Patient Case
- **Cancer type**: Malignant peripheral nerve sheath tumor (MPNST) of the neck
- **Stage**: High-grade, 8cm, deep to sternocleidomastoid
- **Molecular markers**: NF1 germline mutation (neurofibromatosis type 1), PRC2 loss (SUZ12/EED), TP53 mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: neurofibromatosis type 1 — multiple neurofibromas
- **Comorbidities**: NF1-related plexiform neurofibroma (transformation)
...
Save the JSON report to: experiment_reports/HN3-031_report.json
