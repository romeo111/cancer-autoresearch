...
## Patient Case
- **Cancer type**: Nasopharyngeal carcinoma — skull base invasion with cranial nerve palsies
- **Stage**: Stage IVA (T4N2M0, cavernous sinus invasion, CN III/VI palsy)
- **Molecular markers**: EBV+, PD-L1 CPS >=50, high plasma EBV DNA (>4000 copies/mL)
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: Cantonese Chinese descent, family history NPC
- **Comorbidities**: diplopia, facial pain
...
Save the JSON report to: experiment_reports/HN3-043_report.json
