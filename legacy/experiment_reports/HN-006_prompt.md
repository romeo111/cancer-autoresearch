...
- **Molecular markers**: PD-L1 CPS <1, NOTCH1 mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: betel nut/tobacco chewing history, poor dental hygiene
...
Save the JSON report to: experiment_reports/HN-006_report.json
