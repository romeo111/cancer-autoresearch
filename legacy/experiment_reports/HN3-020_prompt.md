...
## Patient Case
- **Cancer type**: Secretory carcinoma of the parotid (NTRK fusion-positive, formerly MASC)
- **Stage**: Stage II (T2N0M0)
- **Molecular markers**: ETV6-NTRK3 fusion positive, S100+, mammaglobin+
...
Save the JSON report to: experiment_reports/HN3-020_report.json
