...
## Patient Case
- **Cancer type**: Pyriform sinus squamous cell carcinoma — early stage, organ preservation candidate
- **Stage**: Stage II (T2N0M0)
- **Molecular markers**: PD-L1 CPS 10, EGFR overexpressed
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 25 pack-year smoking
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-009_report.json
