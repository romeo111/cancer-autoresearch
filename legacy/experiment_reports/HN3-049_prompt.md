...
## Patient Case
- **Cancer type**: Adenosquamous carcinoma of the larynx
- **Stage**: Stage III (T3N1M0)
- **Molecular markers**: PD-L1 CPS 10, TP53 mutated, dual SCC + adenocarcinoma components
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 30 pack-year smoking
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-049_report.json
