...
## Patient Case
- **Cancer type**: Glomus jugulare tumor (jugular paraganglioma)
- **Stage**: Fisch Class D1 (intracranial extradural extension)
- **Molecular markers**: SDHD mutation (PGL1), SSTR2 positive, no catecholamine secretion
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: family history — autosomal dominant PGL1
- **Comorbidities**: pulsatile tinnitus, progressive hearing loss left ear
...
Save the JSON report to: experiment_reports/HN3-030_report.json
