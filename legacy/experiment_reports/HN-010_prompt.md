...
## Patient Case
- **Cancer type**: Anaplastic thyroid carcinoma (ATC)
- **Stage**: Stage IVB (T4bN1bM0)
- **Molecular markers**: BRAF V600E+, TP53 mutated, TERT promoter mutated, PD-L1 high
- **Patient**: 45 year old male
- **Performance status**: ECOG 2
- **Risk factors**: long-standing multinodular goiter, possible de-differentiation from PTC
...
Save the JSON report to: experiment_reports/HN-010_report.json
