...
## Patient Case
- **Cancer type**: Post-laryngectomy stomal recurrence of laryngeal SCC
- **Stage**: Recurrent (stomal mass 3cm, bilateral paratracheal nodes)
- **Molecular markers**: PD-L1 CPS >=20, TP53 mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: total laryngectomy 14 months ago for T4a glottic SCC, subglottic extension was present
- **Comorbidities**: permanent tracheostome, hypothyroidism post-surgery
...
Save the JSON report to: experiment_reports/HN3-013_report.json
