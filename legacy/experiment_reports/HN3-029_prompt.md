...
## Patient Case
- **Cancer type**: Locally advanced basal cell carcinoma of the nose — vismodegib candidate
- **Stage**: Locally advanced (T3, nasal ala + lip involvement, inoperable without major deformity)
- **Molecular markers**: PTCH1 loss-of-function, SMO wild-type (no resistance mutation)
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: Gorlin syndrome (PTCH1 germline mutation), multiple prior BCCs excised
- **Comorbidities**: jaw keratocysts (Gorlin)
...
Save the JSON report to: experiment_reports/HN3-029_report.json
