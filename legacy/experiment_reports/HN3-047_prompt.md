...
## Patient Case
- **Cancer type**: Parotid Warthin tumor with incidental mucoepidermoid carcinoma (collision tumor)
- **Stage**: T1N0M0 (incidental MEC within Warthin's, low-grade)
- **Molecular markers**: CRTC1-MAML2 fusion positive (MEC component), low Ki-67
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: smoking (Warthin's association)
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-047_report.json
