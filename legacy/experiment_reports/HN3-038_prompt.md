...
## Patient Case
- **Cancer type**: Radiation-induced sarcoma of the neck (undifferentiated pleomorphic sarcoma post-Hodgkin's RT)
- **Stage**: High-grade, 6cm, neck soft tissue
- **Molecular markers**: complex karyotype, no specific fusion, TP53 mutated, RB1 loss
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: Hodgkin lymphoma treated with mantle RT at age 20 (25 years prior)
- **Comorbidities**: hypothyroidism (radiation-induced), coronary artery disease (radiation-induced)
...
Save the JSON report to: experiment_reports/HN3-038_report.json
