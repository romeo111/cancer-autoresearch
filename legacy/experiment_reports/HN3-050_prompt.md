...
## Patient Case
- **Cancer type**: Spindle cell carcinoma (sarcomatoid SCC) of the oral cavity
- **Stage**: Stage III (T3N0M0, polypoid tongue mass)
- **Molecular markers**: PD-L1 CPS 20, TP53 mutated, vimentin+, cytokeratin focally+
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: prior radiation to oral cavity
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-050_report.json
