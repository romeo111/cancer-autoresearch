...
## Patient Case
- **Cancer type**: Ameloblastic carcinoma of the mandible
- **Stage**: Stage IVA (T4aN1M0, cortical breakthrough + soft tissue extension)
- **Molecular markers**: BRAF V600E mutated, SMO mutated, amelogenin+
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: prior ameloblastoma curettage 10 years ago (recurrence with malignant transformation)
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-055_report.json
