...
## Patient Case
- **Cancer type**: Head and neck SCC with paraneoplastic hypercalcemia (PTHrP-secreting)
- **Stage**: Stage IVB (T4bN3M0, unresectable floor of mouth SCC)
- **Molecular markers**: PTHrP elevated, PD-L1 CPS 5, TP53 mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 2
- **Risk factors**: 35 pack-year smoking
- **Comorbidities**: hypercalcemia (calcium 14.2 mg/dL), dehydration, confusion
...
Save the JSON report to: experiment_reports/HN3-039_report.json
