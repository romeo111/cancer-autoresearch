...
## Patient Case
- **Cancer type**: HPV-positive oropharyngeal SCC in never-smoker — T4aN3bM0 (unfavorable risk despite HPV+)
- **Stage**: Stage III (AJCC 8th HPV+, T4aN3bM0)
- **Molecular markers**: HPV p16+, PD-L1 CPS >=20, SMAD4 loss, PIK3CA mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: never-smoker
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-057_report.json
