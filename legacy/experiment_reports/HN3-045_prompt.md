...
## Patient Case
- **Cancer type**: Second primary oropharyngeal SCC after prior oral tongue SCC (5 years post-treatment)
- **Stage**: Stage II (T2N1M0, HPV+, new primary confirmed)
- **Molecular markers**: HPV p16+, PD-L1 CPS >=20, different TP53 status from original tumor
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: prior oral tongue SCC treated with surgery + adjuvant RT 5 years ago, 10 pack-year smoking (quit)
- **Comorbidities**: prior RT to ipsilateral neck, mild xerostomia from prior treatment
...
Save the JSON report to: experiment_reports/HN3-045_report.json
