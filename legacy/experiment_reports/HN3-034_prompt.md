...
## Patient Case
- **Cancer type**: Adult rhabdomyosarcoma of the nasopharynx (alveolar type)
- **Stage**: Stage III (T2bN1M0)
- **Molecular markers**: PAX3-FOXO1 fusion positive, desmin+, myogenin+
...
Save the JSON report to: experiment_reports/HN3-034_report.json
