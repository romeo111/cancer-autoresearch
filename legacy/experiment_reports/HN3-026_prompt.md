...
## Patient Case
- **Cancer type**: Papillary thyroid carcinoma — cribriform-morular variant (FAP-associated)
- **Stage**: Stage I (T2N0M0, multifocal bilateral)
- **Molecular markers**: APC germline mutation (FAP), beta-catenin nuclear positive, BRAF wild-type, estrogen receptor positive
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: familial adenomatous polyposis, prior colectomy for colon polyps
- **Comorbidities**: FAP — ongoing GI surveillance
...
Save the JSON report to: experiment_reports/HN3-026_report.json
