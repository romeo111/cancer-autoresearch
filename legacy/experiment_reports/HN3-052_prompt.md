...
## Patient Case
- **Cancer type**: Papillary squamous cell carcinoma of the oropharynx (HPV-associated)
- **Stage**: Stage I (T2N1M0, AJCC 8th HPV+)
- **Molecular markers**: HPV p16+, exophytic papillary architecture, PD-L1 CPS >=20
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: HPV exposure
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-052_report.json
