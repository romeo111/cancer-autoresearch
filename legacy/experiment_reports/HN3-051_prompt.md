...
- **Stage**: Stage IVA (T3N2M0)
- **Molecular markers**: HPV p16-, PD-L1 CPS 10, TP53 mutated, high Ki-67 (60%)
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: 30 pack-year smoking, alcohol
- **Comorbidities**: malnutrition (BMI 19)
...
Save the JSON report to: experiment_reports/HN3-051_report.json
