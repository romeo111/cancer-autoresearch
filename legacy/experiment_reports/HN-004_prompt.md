...
## Patient Case
- **Cancer type**: Nasopharyngeal carcinoma (WHO Type II/III, EBV-associated)
- **Stage**: Stage III (T3N1M0)
- **Molecular markers**: EBV+, PD-L1 CPS ≥50, high plasma EBV DNA
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: Southeast Asian descent, family history of NPC
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN-004_report.json
