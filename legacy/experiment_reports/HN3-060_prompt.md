...
## Patient Case
- **Cancer type**: Kaposi sarcoma of the oral cavity and oropharynx (HHV-8 associated)
- **Stage**: T1 (oral palate + oropharyngeal involvement)
- **Molecular markers**: HHV-8 positive, LANA-1 positive, HIV-associated (classic vs endemic ruled out)
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: HIV+ on ART, CD4 250 (recovering)
- **Comorbidities**: HIV on ART, oral candidiasis
...
Save the JSON report to: experiment_reports/HN3-060_report.json
