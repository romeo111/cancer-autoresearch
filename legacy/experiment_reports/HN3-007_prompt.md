...
## Patient Case
- **Cancer type**: Nasopharyngeal carcinoma — WHO Type I (keratinizing, EBV-negative)
- **Stage**: Stage III (T3N2M0)
- **Molecular markers**: EBV negative, PD-L1 CPS 5, TP53 mutated, PIK3CA mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: heavy smoking 30 years
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-007_report.json
