...
## Patient Case
- **Cancer type**: Sublingual gland adenoid cystic carcinoma
- **Stage**: Stage II (T2N0M0, perineural invasion)
- **Molecular markers**: MYB-NFIB fusion positive, NOTCH1 activated
...
Save the JSON report to: experiment_reports/HN3-041_report.json
