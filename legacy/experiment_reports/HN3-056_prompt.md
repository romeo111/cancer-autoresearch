...
## Patient Case
- **Cancer type**: Nasal cavity biphenotypic sinonasal sarcoma (BSNS)
- **Stage**: Localized (nasal cavity, 3cm)
- **Molecular markers**: PAX3 rearrangement, S100+, SMA+, low-grade
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 
- **Comorbidities**: nasal obstruction
...
Save the JSON report to: experiment_reports/HN3-056_report.json
