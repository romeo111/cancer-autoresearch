...
## Patient Case
- **Cancer type**: HPV-negative oropharyngeal squamous cell carcinoma
- **Stage**: Stage IVA (T3N2bM0)
- **Molecular markers**: HPV p16-, PD-L1 CPS 5-10, TP53 mutated
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: 20 pack-year smoking history, heavy alcohol use
...
Save the JSON report to: experiment_reports/HN-002_report.json
