...
## Patient Case
- **Cancer type**: Inverted papilloma of nasal cavity with focal carcinoma transformation
- **Stage**: Krouse T3 (focal SCC transformation within inverted papilloma)
- **Molecular markers**: HPV-11 associated, EGFR overexpressed in carcinoma component, p53 overexpressed in carcinoma foci
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: recurrent nasal polyps, 3 prior endoscopic resections for inverted papilloma
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-059_report.json
