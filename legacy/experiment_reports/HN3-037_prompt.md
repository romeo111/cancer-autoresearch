...
## Patient Case
- **Cancer type**: Head and neck squamous cell carcinoma in HIV/AIDS patient (oropharyngeal, HPV+)
- **Stage**: Stage II (T2N1M0, AJCC 8th)
- **Molecular markers**: HPV p16+, PD-L1 CPS >=20, HIV viral load undetectable on ART
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: HIV+ for 15 years, on antiretroviral therapy (ART), CD4 350
- **Comorbidities**: HIV on ART, lipodystrophy, ART drug interactions
...
Save the JSON report to: experiment_reports/HN3-037_report.json
