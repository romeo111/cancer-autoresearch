...
## Patient Case
- **Cancer type**: Laryngeal small cell carcinoma (neuroendocrine, pulmonary-type)
- **Stage**: Stage III (T3N1M0, extensive stage behavior)
- **Molecular markers**: synaptophysin+, chromogranin+, TTF-1 negative, Ki-67 90%, RB1 loss, TP53 mutated
...
Save the JSON report to: experiment_reports/HN3-044_report.json
