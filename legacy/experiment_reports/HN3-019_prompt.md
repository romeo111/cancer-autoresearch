...
## Patient Case
- **Cancer type**: Salivary duct carcinoma of the parotid (AR+, HER2+)
- **Stage**: Stage IVA (T4aN2M0, facial nerve invaded)
- **Molecular markers**: AR strongly positive, HER2 3+ (amplified), PI3K mutated, TP53 mutated
...
Save the JSON report to: experiment_reports/HN3-019_report.json
