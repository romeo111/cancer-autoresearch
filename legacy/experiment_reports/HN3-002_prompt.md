...
- **Stage**: Stage III (T3N1M0, mandibular cortical invasion)
- **Molecular markers**: PD-L1 CPS 15, CDKN2A loss
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 30 pack-year smoking, chronic periodontitis
...
Save the JSON report to: experiment_reports/HN3-002_report.json
