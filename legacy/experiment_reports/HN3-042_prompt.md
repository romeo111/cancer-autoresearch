...
## Patient Case
- **Cancer type**: Dermatofibrosarcoma protuberans (DFSP) of the neck — locally advanced
- **Stage**: Locally advanced (8cm, involving sternocleidomastoid, COL1A1-PDGFB fusion+)
- **Molecular markers**: COL1A1-PDGFB fusion (t(17;22)), CD34+, low-grade with fibrosarcomatous transformation areas
...
Save the JSON report to: experiment_reports/HN3-042_report.json
