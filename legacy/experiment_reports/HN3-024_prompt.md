...
## Patient Case
- **Cancer type**: Thyroid lymphoma — primary DLBCL arising in Hashimoto's thyroiditis
- **Stage**: Stage IIE (thyroid + cervical nodes)
- **Molecular markers**: CD20+, BCL2+, non-GCB (ABC) subtype, MYD88 wild-type
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: Hashimoto's thyroiditis 15 years
- **Comorbidities**: hypothyroidism on levothyroxine
...
Save the JSON report to: experiment_reports/HN3-024_report.json
