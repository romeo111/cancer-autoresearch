...
## Patient Case
- **Cancer type**: Oral cavity SCC with massive cervical lymphadenopathy (N3b, skin involvement)
- **Stage**: Stage IVB (T2N3bM0, fixed matted nodes with skin ulceration)
- **Molecular markers**: PD-L1 CPS 30, TP53 mutated, EGFR amplified
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: delayed presentation (6 months of neck mass growth)
- **Comorbidities**: skin breakdown over nodes, wound care needs
...
Save the JSON report to: experiment_reports/HN3-046_report.json
