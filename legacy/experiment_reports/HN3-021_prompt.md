...
## Patient Case
- **Cancer type**: Polymorphous adenocarcinoma of the hard palate (minor salivary gland)
- **Stage**: Stage I (T1N0M0, low-grade)
- **Molecular markers**: PRKD1 hotspot mutation, low Ki-67 (<5%)
...
Save the JSON report to: experiment_reports/HN3-021_report.json
