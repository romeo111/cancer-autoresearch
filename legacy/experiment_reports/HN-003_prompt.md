...
- **Molecular markers**: PD-L1 CPS 1-5, EGFR overexpressed
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 25 pack-year smoking history
...
Save the JSON report to: experiment_reports/HN-003_report.json
