...
- **Molecular markers**: PD-L1 CPS 10-20, p53 mutant, CDKN2A loss
- **Patient**: 45 year old male
- **Performance status**: ECOG 1
- **Risk factors**: 30 pack-year smoking, heavy alcohol use, iron deficiency history
...
Save the JSON report to: experiment_reports/HN-005_report.json
