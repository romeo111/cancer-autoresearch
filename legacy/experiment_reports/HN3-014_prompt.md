...
## Patient Case
- **Cancer type**: Nasal cavity squamous cell carcinoma
- **Stage**: Stage III (T3N0M0, ethmoid extension)
- **Molecular markers**: PD-L1 CPS 10, EGFR overexpressed
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: nickel refining occupational exposure
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-014_report.json
