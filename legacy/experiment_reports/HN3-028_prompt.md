...
## Patient Case
- **Cancer type**: Cutaneous melanoma of the scalp — BRAF V600E mutated
- **Stage**: Stage IIIC (T4bN2cM0, in-transit metastases, ulcerated, 5mm Breslow)
- **Molecular markers**: BRAF V600E+, PD-L1 TPS 60%, TMB-high
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: fair skin, blistering sunburns in childhood, family history melanoma
- **Comorbidities**: none
...
Save the JSON report to: experiment_reports/HN3-028_report.json
