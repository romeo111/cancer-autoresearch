...
## Patient Case
- **Cancer type**: Scalp angiosarcoma
- **Stage**: Locally advanced (15cm, multifocal, scalp + forehead)
- **Molecular markers**: VEGFR amplified, MYC amplified, KDR mutated, PD-L1 TPS 20%
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: chronic lymphedema of scalp (post-radiation for prior cancer at age 10)
- **Comorbidities**: radiation-induced field defect
...
Save the JSON report to: experiment_reports/HN3-027_report.json
