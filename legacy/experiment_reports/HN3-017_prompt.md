...
## Patient Case
- **Cancer type**: Burkitt lymphoma of the jaw
- **Stage**: Stage II (jaw mass + cervical nodes)
- **Molecular markers**: CD20+, CD10+, Ki-67 ~100%, MYC rearrangement (t(8;14)), EBV negative (sporadic type)
...
Save the JSON report to: experiment_reports/HN3-017_report.json
