...
## Patient Case
- **Cancer type**: Sinonasal hemangiopericytoma (solitary fibrous tumor, sinonasal type)
- **Stage**: Localized (nasal cavity, 4cm)
- **Molecular markers**: NAB2-STAT6 fusion positive, STAT6 nuclear positive, low mitotic rate
- **Patient**: 45 year old male
- **Performance status**: ECOG 0
- **Risk factors**: 
- **Comorbidities**: recurrent epistaxis
...
Save the JSON report to: experiment_reports/HN3-032_report.json
