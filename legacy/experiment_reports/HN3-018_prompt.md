...
- **Stage**: Stage IIA (bilateral cervical + mediastinal)
- **Molecular markers**: CD30+, CD15+, EBV negative, PD-L1 high on Reed-Sternberg cells
...
Save the JSON report to: experiment_reports/HN3-018_report.json
