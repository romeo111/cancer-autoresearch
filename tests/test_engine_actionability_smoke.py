...
with the expected ESCAT / OncoKB tiers.

CSD-1 prep: the partnership pitch demonstrates that an NGS
report → tumor-board brief flow surfaces ESMO-grade and OncoKB-grade
clinical context next to the chosen track. This test is the engine's
side of that integration; downstream CSD-1-tests adds 5 known-case
fixtures, CSD-1-demo packages the BRAF-V600E mCRC pitch HTML.
"""
...
def test_braf_v600e_mcrc_actionability_lookup():
    ...
    (BMA-BRAF-V600E-CRC), ESCAT IB, OncoKB Level 1. No warnings on the
    actionability path."""
    patient = {
