...
def test_at_least_70_percent_drugs_registered(drug_yamls):
    ...
    after CSD-2; drifts to ~70% after CSD-3..7 solid-tumor expansion
    (more not-yet-registered novel agents). Falls below 65% only if
    a regression mass-flipped drugs to registered=False."""
